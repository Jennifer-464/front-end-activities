const generateMemeBtn = document.getElementById("btn-meme");
const generateJokeBtn = document.getElementById("btn-joke");
const generateQuoteBtn = document.getElementById("btn-quote");
const generateRiddleBtn = document.getElementById("btn-riddle");
const revealRiddleAnswer = document.getElementById("btn-riddle-answer");

generateMemeBtn.addEventListener("click", () => {
    const randomMeme = getRandomData('memes');
    const displayDiv = document.getElementById("display-meme");

    const imgNode = document.createElement("img"); 
    imgNode.src = randomMeme;
    
    clearAll();
    displayDiv.appendChild(imgNode);
})
...
generateJokeBtn.addEventListener("click", () => {
    ...
    paragraphNode.textContent = randomJoke;
    
    clearAll();
    displayDiv.appendChild(paragraphNode);
})

generateQuoteBtn.addEventListener("click", () => {
    const randomQuote = getRandomData('quotes');
    const displayDiv = document.getElementById("display-quote");

    const quoteNode = document.createElement("p");
    quoteNode.textContent = randomQuote.quote;
    
    const authorNode = document.createElement("p");
    authorNode.textContent = "- " + randomQuote.author;
    
    clearAll();
    displayDiv.appendChild(quoteNode);
    displayDiv.appendChild(authorNode);
})
...
generateRiddleBtn.addEventListener("click", () => {
    ...
    answerNode.style.visibility = "hidden";
    
    clearAll();
    displayDiv.appendChild(questionNode);
    displayDiv.appendChild(answerNode);
})
...
function clearAll() {
    const meme = document.getElementById("display-meme");
    const joke = document.getElementById("display-joke");
    const quote = document.getElementById("display-quote");
    const riddle = document.getElementById("display-riddle");
 ...
 * 
 * Valid arguments: memes / jokes / quotes / riddles
 *
...
function getRandomData(type) {
    ...
    // data[memes][randomIndex] --> ""
    // data[jokes][randomIndex] --> ""
    // data[quotes][randomIndex] --> {quote:"", author:""}
    // data[riddles][randomIndex] --> {question:"", answer:""}
}
